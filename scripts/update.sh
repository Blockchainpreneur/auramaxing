...
echo -e "${Y}  │${R}  Updating is now MANDATORY: only the latest version is    ${Y}│${R}"
echo -e "${Y}  │${R}  supported, and prompts stay blocked until you update.    ${Y}│${R}"
echo -e "${Y}  │${R}                                                          ${Y}│${R}"
echo -e "${Y}  │${R}  Continued use of AURAMAXING will become                  ${Y}│${R}"
echo -e "${Y}  │${R}  ${B}USD \$1,499 per user / year${R} — ${B}not charged yet${R}.          ${Y}│${R}"
echo -e "${Y}  │${R}  Advance notice so the price is not a surprise.           ${Y}│${R}"
echo -e "${Y}${B}  └──────────────────────────────────────────────────────────┘${R}"
echo ""
