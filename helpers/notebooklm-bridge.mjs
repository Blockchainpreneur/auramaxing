...
switch (command) {
  ...
  case 'compress-memory': {
    ...
    const compressed = nlm(`ask "Compress these session logs into a 3-sentence briefing. Include: project, key decisions, current status, next actions: ${shEsc(raw.slice(0, 2000))}"`);
