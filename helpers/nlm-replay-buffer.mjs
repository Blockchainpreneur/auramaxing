...
function postNote(noteTitle, noteContent) {
  ...
  // Escape for a double-quoted bash context: backslash first, then the chars
  // that stay live inside double quotes ($, backtick, "). Prevents `$()`/backtick
  // command substitution in the note title.
