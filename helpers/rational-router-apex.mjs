...
async function main() {
  ...
  const tier           = billion ? 'OPUS 4.8 · BILLION' : ultramax ? 'OPUS 4.8 · ULTRAMAX' : opusWindow ? 'OPUS 4.8' : complexity < 30 ? 'HAIKU' : complexity < 65 ? 'SONNET' : 'OPUS';
