...
// Single-quote a value for bash so $(), backticks, and other metachars stay inert.
function shq(value) {
...
export async function flush({ limit = Infinity } = {}) {
  ...
  // Preserve entries beyond the limit so they aren't dropped after the buffer was truncated
